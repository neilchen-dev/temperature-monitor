...
FEISHU_OPERATION_INITIATOR_ID_TYPE = os.getenv(
    "FEISHU_OPERATION_INITIATOR_ID_TYPE", "open_id"
).strip().lower()
FEISHU_OPERATION_OVERDUE_NOTIFY_ENABLED = _get_bool(
    "FEISHU_OPERATION_OVERDUE_NOTIFY_ENABLED", True
)
FEISHU_OPERATION_OVERDUE_AFTER_HOURS = max(
    0, _get_int("FEISHU_OPERATION_OVERDUE_AFTER_HOURS", 6)
)
FEISHU_OPERATION_OVERDUE_REPEAT_HOURS = max(
    1, _get_int("FEISHU_OPERATION_OVERDUE_REPEAT_HOURS", 1)
)
FEISHU_OPERATION_OVERDUE_FORM_URL = os.getenv(
    "FEISHU_OPERATION_OVERDUE_FORM_URL",
...
FEISHU_DEVICE_STATUS_TEMPERATURE_MIN_FIELD = os.getenv(
    "FEISHU_DEVICE_STATUS_TEMPERATURE_MIN_FIELD", "当前适用温度下限（°C）"
).strip()
FEISHU_DEVICE_STATUS_TEMPERATURE_MAX_FIELD = os.getenv(
    "FEISHU_DEVICE_STATUS_TEMPERATURE_MAX_FIELD", "当前适用温度上限（°C）"
).strip()
FEISHU_DEVICE_STATUS_HUMIDITY_MIN_FIELD = os.getenv(
    "FEISHU_DEVICE_STATUS_HUMIDITY_MIN_FIELD", "当前适用湿度下限（%RH）"
).strip()
FEISHU_DEVICE_STATUS_HUMIDITY_MAX_FIELD = os.getenv(
    "FEISHU_DEVICE_STATUS_HUMIDITY_MAX_FIELD", "当前适用湿度上限（%RH）"
).strip()
